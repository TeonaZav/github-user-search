...
const LogoSun = () => {
  const { darkLogoColor } = React.useContext(GithubContext);
  return (
    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
      <g fill={darkLogoColor} fillRule="nonzero">
...
const LogoMoon = () => {
  const { lightLogoColor } = React.useContext(GithubContext);
  return (
    <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
      <path
        className="logo"
